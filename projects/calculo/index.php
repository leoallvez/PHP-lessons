		...
		<div id="principal">
			<form method="get" action="result.php">
				...
				<fieldset>
					...
					<input type="number" name="m1" value="0" id="nm1" list="lista" step="0.1" min="0" max="10" onFocus="limpa('nm1')" onBlur="zera('nm1')"></br>
					<?php notas(); ?>
				</fieldset>
				<fieldset>
					<legend><strong>M2</strong></legend>
					<label for="nnd">Nota Diciplina:</label></br>
					<input type="number" name="nd" value="0" id="nnd" list="lista" step="0.1" min="0" max="10" onFocus="limpa('nnd')" onBlur="zera('nnd')"></br>
					<?php notas(); ?>
					<label for="nni">Nota Integrada: </label></br>
					<input type="number" name="ni" value="0" id="nni" list="lista" step="0.1" min="0" max="10" onFocus="limpa('nni')" onBlur="zera('nni')"></br>
					<?php notas(); ?>
				</fieldset>
